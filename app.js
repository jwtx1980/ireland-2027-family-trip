(() => {
  ...
  function renderBookings() {
    ...
    }).join("")}</div><div class="settlement-note"><strong>Current lodging settlement</strong><p>Williams family contributes ${moneyExact(DATA.costs.lodgingPerPayer * 3)} to the lodging pool. If the full booked lodging commitment is settled now, allocate ${moneyExact(1711.9485714286)} to the Justin family and ${moneyExact(101.6285714286)} to the Cameron family.</p></div><p class="ledger-footnote">This ledger covers only the two homes already booked. It excludes airfare, both SUVs, Dublin lodging, fuel, mileage, tolls, parking, food and activities. “Booked by family” is the obligation assigned to that family, not proof that every vendor installment has already posted.</p>`;
  }
